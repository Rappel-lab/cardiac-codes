...
prompt = {'Enter Start Time (ms):','How many windows (2000 ms/window, default = 2):','Sampling Frequency (Stanford Files should be 977)','Enter Offset:','Left or Right Atrium:','Invert Traces (1 = no, 2 = yes)?'};
